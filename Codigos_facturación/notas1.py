...
def notas(rango,f,folio,auto_confirm=False):
    for i in range(rango):#len(f)):
       ...
       "password": "portalxiix",
       "datosAdicionales": {
        "DocumentoNota": \"Periodo ECD:"""+perecd+""" Factura (FUF):"""+str(f['FUF'][i])+""" Fecha Limite de Pago:"""+flimite+""" ID Participante:"""+str(f['Participante'][i])+""" Correo:escuderop@xiix.mx Ref. Banco:"""+str(f['FUF'][i])+""" Sucursal:0031 Banco:BBVA Cuenta:0114254848 CLABE:012180001142548489\",
        "TipoDeComprobante": \""""+str(f['Tipo'][i])+"""\" ,
        "LABEL": "CABADD",
        "TIPO_DOC": \""""+t_doc+"""\",
        "CODIGO_FUF": \""""+str(f['FUF'][i])+"""\",
        "PERIODO_ECD": \""""+perecd2+"""\",
        "FECHA_LIM_PAGO": \""""+flimite2+"""\",
        "ID_PARTIC_CENACE": \""""+str(f['Participante'][i])+"""\",
        "BANCO": "BBVA",
        "SUCURSAL": "0031",
        "CUENTA": "0114254848",
        "CLABE": "012180001142548489",
        "REF_BANCO": \""""+str(f['FUF'][i])+"""\",
          ...
          "Concepto": [
            {
              ...
              "NoIdentificacion": \""""+str(f['No. Identificacion'][i])+"""\",
