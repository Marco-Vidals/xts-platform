...
def factura(rango,f,folio,auto_confirm=False):
    for i in range(rango,rango+1):#len(f)):
        ...
        body=u"""{
          ...
          "datosAdicionales": {
            ...
            "NUM_LIN_2": "3",
            "LABEL_2": "LINADD",
            "FOLIO_UNICO_2":\""""+f['No. Identificacion'][i+2]+"""\",
            "NUM_LIN_3": "4",
            "LABEL_3": "LINADD",
            "FOLIO_UNICO_3":\""""+f['No. Identificacion'][i+3]+"""\"
          },
          "Comprobante": {
            "Exportacion":"01",
            "Serie": "Factura",
            "Folio":\""""+str(folio)+"""\",
            "Fecha":\""""+str(dia)+"""\",
            "SubTotal":\""""+f"{float(f['Subtotal'][i]+f['Subtotal'][i+1]+f['Subtotal'][i+2]+f['Subtotal'][i+3]):.2f}"+"""\",
            "Moneda": "MXN",
            "Total":\""""+f"{float(f['TOTAL'][i]+f['TOTAL'][i+1]+f['TOTAL'][i+2]+f['TOTAL'][i+3]):.2f}"+"""\",
            "TipoDeComprobante": "I",
            "FormaPago": "99",
            "MetodoPago": "PPD",
